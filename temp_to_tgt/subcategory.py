...
tgt_table_name = "D_RETAIL_SUB_CTGRY_T"
...
try:
    ...
    query = f"""
    INSERT INTO {Variables.get_value("target_database")}.{tgt_table_name} (SUB_CTGRY_ID, CTGRY_KY, SUB_CTGRY_DESC, OPEN_CLOSE_CD, ROW_INSRT_TMS, ROW_UPDT_TMS)
    SELECT
        SUB_CTGRY_ID,
        CTGRY_KY,
        SUB_CTGRY_DESC,
