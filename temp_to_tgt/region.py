...
try:
    ...
    query = f"""
    INSERT INTO {Variables.get_value("target_database")}.{tgt_table_name} (RGN_ID, CNTRY_KY, RGN_DESC, OPEN_CLOSE_CD, ROW_INSRT_TMS, ROW_UPDT_TMS)
    SELECT
        RGN_ID,
        CNTRY_KY,
        RGN_DESC,
