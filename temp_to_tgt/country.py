...
tgt_table_name = "D_RETAIL_CNTRY_T"
...
try:
    ...
    query = f"""
    INSERT INTO {Variables.get_value("target_database")}.{tgt_table_name} (CNTRY_ID, CNTRY_DESC, OPEN_CLOSE_CD, ROW_INSRT_TMS, ROW_UPDT_TMS)
    SELECT
        CNTRY_ID,
        CNTRY_DESC,
        'O',
